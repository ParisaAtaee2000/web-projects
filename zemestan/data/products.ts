...
const standardSizeBreakdown = { L: 2, XL: 2, "2XL": 2, "3XL": 2 } as const;
...
export const products: Product[] = [
  {
    ...
    ], jeanPack: { piecesPerPack: 8, sizeBreakdown: standardSizeBreakdown, colorBreakdown: {"مشکی":3,"زغالی":3,"قهوه‌ای":2} }, material: "پارچه ضدآب با آستر گرم", season: "زمستان", fit: "Regular", isActive: true,
  },
  {
    ...
    ], jeanPack: { piecesPerPack: 8, sizeBreakdown: standardSizeBreakdown, colorBreakdown: {"زغالی":4,"مشکی":4} }, material: "فوتر ترکیبی", season: "زمستان", fit: "Regular", isActive: true,
  },
  {
    ...
    ], jeanPack: { piecesPerPack: 8, sizeBreakdown: standardSizeBreakdown, colorBreakdown: {"مشکی":4,"قهوه‌ای":4} }, material: "چرم صنعتی با آستر گرم", season: "زمستان", fit: "Slim", isActive: true,
  },
  {
    ...
    ], jeanPack: { piecesPerPack: 8, sizeBreakdown: standardSizeBreakdown, colorBreakdown: {"سبز زیتونی":4,"مشکی":4} }, material: "پارچه تکنیکال ضدباد", season: "زمستان", fit: "Relaxed", isActive: true,
  },
  {
    ...
    ], jeanPack: { piecesPerPack: 8, sizeBreakdown: standardSizeBreakdown, colorBreakdown: {"زغالی":4,"مشکی":4} }, material: "پارچه تکنیکال ضدآب", season: "زمستان", fit: "Regular", isActive: true,
  },
];
